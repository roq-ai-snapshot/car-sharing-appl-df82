  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience a new way of commuting with Car Sharing Application - your ultimate platform for seamless and efficient vehicle sharing solutions."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience a new way of commuting with Car Sharing Application - your ultimate platform for seamless and efficient vehicle sharing solutions.`}
            </Text>
            <Box
